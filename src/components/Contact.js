...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/d626477e-101b-4dbf-a91d-63f41e8d7937" className='flex flex-col max-w-[600px] w-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-purple-600 text-gray-300'>Contact</p>
                <p className='text-gray-300 py-4'>Let's chat!</p>
            </div>
